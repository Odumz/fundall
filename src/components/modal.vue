  ...
  <teleport to="body">
    ...
    >
      <div
        ...
        v-show="showModal"
      >
        <svg v-if="showCancelButton" @click="close" class="cursor-pointer text-rezumii-black-200 drop-shadow-xl relative top-[17vh] -right-[93vw]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
